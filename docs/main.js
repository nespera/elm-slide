...
var _nespera$elm_slide$Model$cartesian = F2(
	function (xs, ys) {
		return A2(
...
var _nespera$elm_slide$Model$coverage = function (piece) {
	var c = piece.position.c;
	var allCols = A2(_elm_lang$core$List$range, c, (piece.shape.width - 1) + c);
	var r = piece.position.r;
	var allRows = A2(_elm_lang$core$List$range, r, (piece.shape.height - 1) + r);
...
var _nespera$elm_slide$Model$Piece = F3(
	function (a, b, c) {
		return {name: a, shape: b, position: c};
	});
var _nespera$elm_slide$Model$Shape = F3(
	function (a, b, c) {
		return {width: a, height: b, color: c};
	});
var _nespera$elm_slide$Model$Position = F2(
	function (a, b) {
		return {r: a, c: b};
	});
...
var _nespera$elm_slide$Msg$Choose = function (a) {
	return {ctor: 'Choose', _0: a};
};

var _nespera$elm_slide$View$flash = A2(
	_elm_lang$svg$Svg$animate,
	{
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$to('0.5'),
					_1: {
						ctor: '::',
	...
	{ctor: '[]'});
var _nespera$elm_slide$View$renderPiece = F2(
	function (model, piece) {
		var opacity = _nespera$elm_slide$Model$gameOver(model) ? 0.5 : 1.0;
		var h = 100 * piece.shape.height;
		var w = 100 * piece.shape.width;
		var yPos = 100 * piece.position.r;
		var yMid = yPos + ((h / 2) | 0);
		var xPos = 100 * piece.position.c;
		var xMid = xPos + ((w / 2) | 0);
		var isActive = _elm_lang$core$Native_Utils.eq(piece.name, model.active);
		var animate = (isActive && (!_nespera$elm_slide$Model$gameOver(model))) ? {
			ctor: '::',
			_0: _nespera$elm_slide$View$flash,
			_1: {ctor: '[]'}
		} : {ctor: '[]'};
		return A2(
			_elm_lang$svg$Svg$g,
			{
				...
				_0: _elm_lang$svg$Svg_Events$onClick(
					_nespera$elm_slide$Msg$Choose(piece.name)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$fill(piece.shape.color),
												_1: {
													ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_elm_lang$svg$Svg$text_,
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$x(
								_elm_lang$core$Basics$toString(xMid)),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$y(
									_elm_lang$core$Basics$toString(yMid + 10)),
								_1: {
									ctor: '::',
						...
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg$text(piece.name),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _nespera$elm_slide$Main$subscriptions = function (model) {
...
var _nespera$elm_slide$Main$makeMove = F2(
	function (model, direction) {
		...
		if (_p1.ctor === 'Just') {
			var _p2 = _p1._0;
			var newPosition = A2(_nespera$elm_slide$Main$updatePosition, _p2.position, direction);
...
var _nespera$elm_slide$Main$handleKeyPress = F2(
	function (model, keyCode) {
		...
		switch (_p4) {
			...
			case 38:
				return A2(_nespera$elm_slide$Main$makeMove, model, _nespera$elm_slide$Main$Up);
			case 39:
				return A2(_nespera$elm_slide$Main$makeMove, model, _nespera$elm_slide$Main$Right);
			case 40:
				return A2(_nespera$elm_slide$Main$makeMove, model, _nespera$elm_slide$Main$Down);
			default:
				return A2(_elm_lang$core$List$member, $char, names) ? _elm_lang$core$Native_Utils.update(
					model,
					{active: $char}) : model;
		}
	});
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _nespera$elm_slide$Main$main !== 'undefined') {
    _nespera$elm_slide$Main$main(Elm['Main'], 'Main', undefined);
}
